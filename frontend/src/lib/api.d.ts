...
// Direct Transform / DCTE (iter-18) — the fourth Tools section. Project-less.
export declare const dcteBrowseFs: (path?: string) => Promise<any>;
export declare const dcteCreateJob: (payload: Record<string, unknown>) => Promise<any>;
export declare const dcteDeleteJob: (jobId: string) => Promise<any>;
export declare const dcteDetectProject: (sourcePath: string) => Promise<any>;
export declare const dcteGetEvents: (jobId: string, limit?: number) => Promise<any>;
export declare const dcteGetJob: (jobId: string) => Promise<any>;
export declare const dcteGetReports: (jobId: string) => Promise<any>;
export declare const dcteGetTransforms: (jobId: string) => Promise<any>;
export declare const dcteListJobs: (tenantId?: string | null, projectId?: string | null) => Promise<any>;
...
export declare const dcteStartJob: (jobId: string) => Promise<any>;
