      ...
      <header className="bg-white border-b border-[#E6E6E6] px-6 py-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-[#2E2E38] text-white hover:bg-[#1A1A24] rounded-sm text-xs h-8 gap-1.5"
          >
      ...
      <div className="flex-1 overflow-y-auto mos-scroll p-6 bg-[#F6F6FA]">
        <div className="max-w-4xl mx-auto space-y-8" ref={contentRef}>
          ...
          <section className="mos-panel p-8 text-center" data-testid="about-hero">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-[#FFE600] text-[#2E2E38] rounded-lg font-display font-bold text-3xl mb-4">
              L
            </div>
            <h1 className="font-display text-3xl font-bold tracking-tight text-[#2E2E38] mb-2">
              LAMA
            </h1>
            <p className="tagline text-lg text-[#747480] mb-6">
          ...
          <section className="mos-panel p-6" data-testid="about-vision">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Target className="w-5 h-5 mr-2 text-[#FFE600]" />
              Vision & Mission
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-sm text-[#2E2E38] mb-2 flex items-center">
                  <Rocket className="w-4 h-4 mr-1.5 text-[#7C3AED]" />
                  Vision
                </h3>
              ...
              <div>
                <h3 className="font-semibold text-sm text-[#2E2E38] mb-2 flex items-center">
                  <Users className="w-4 h-4 mr-1.5 text-[#7C3AED]" />
                  Mission
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <section className="mos-panel p-6" data-testid="about-pipeline">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Layers className="w-5 h-5 mr-2 text-[#FFE600]" />
            ...
            <div className="space-y-4">
              {STAGES.map((stage, idx) => {
                ...
                return (
                  <div
                    key={stage.key}
                    className="stage-card border border-[#E6E6E6] rounded-sm p-4 bg-white"
                    data-testid={`about-stage-${stage.key}`}
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-sm bg-[#F6F6FA] flex items-center justify-center shrink-0">
                        <Icon className="w-5 h-5 text-[#2E2E38]" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="stage-title font-semibold text-sm text-[#2E2E38] mb-1">
                          {stage.title}
                        </h3>
                        ...
                        <div className="stage-outputs flex flex-wrap gap-1.5">
                          {stage.outputs.map((output) => (
                            <span
                              key={output}
                              className="inline-flex items-center text-[10px] bg-[#F6F6FA] text-slate-600 px-2 py-0.5 rounded-sm"
                            >
                      ...
                      {idx < STAGES.length - 1 && (
                        <ArrowRight className="w-4 h-4 text-slate-300 mt-3 hidden md:block" />
                      )}
                    </div>
                  </div>
                );
          ...
          <section className="mos-panel p-6" data-testid="about-features">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Sparkles className="w-5 h-5 mr-2 text-[#FFE600]" />
              Key Features
            </h2>
            <div className="feature-grid grid md:grid-cols-2 gap-4">
              {FEATURES.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="feature-card border border-[#E6E6E6] rounded-sm p-4 bg-white"
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-sm bg-[#FFFCE6] flex items-center justify-center shrink-0">
                        <Icon className="w-4 h-4 text-[#2E2E38]" />
                      </div>
                      <div>
                        <h3 className="feature-title font-semibold text-sm text-[#2E2E38] mb-1">
                          {feature.title}
                        </h3>
                        <p className="feature-desc text-xs text-slate-600 leading-relaxed">
                          {feature.description}
                        </p>
                      </div>
                    </div>
          ...
          <section className="mos-panel p-6" data-testid="about-tech-stack">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Code2 className="w-5 h-5 mr-2 text-[#FFE600]" />
              Technology Stack
            </h2>
            <table className="tech-table w-full text-xs border-collapse">
              <thead>
                <tr className="bg-[#F6F6FA]">
                  <th className="text-left px-3 py-2 font-semibold text-[#2E2E38] border border-[#E6E6E6]">
                    Layer
                  </th>
                  <th className="text-left px-3 py-2 font-semibold text-[#2E2E38] border border-[#E6E6E6]">
                    Technologies
              ...
              <tbody>
                <tr>
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">Backend</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    Python 3.11, FastAPI 0.110, Motor 3.3 (async MongoDB), Pydantic 2.13, httpx, PyGithub
                  </td>
                </tr>
                <tr className="bg-[#FAFAFA]">
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">LLM Fabric</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    OpenRouter, Anthropic, OpenAI, Groq, Ollama, Gemini — routed by complexity tier (low/medium/high)
                  </td>
                </tr>
                <tr>
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">AI Frameworks</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    LangGraph (multi-agent orchestration, state machines), HuggingFace (confidence scoring, embeddings)
                  </td>
                </tr>
                <tr>
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">Vector DB</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    Qdrant — hybrid retrieval (BM25 + dense embeddings) for RAG-powered chat
                  </td>
                </tr>
                <tr className="bg-[#FAFAFA]">
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">Database</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    MongoDB 7 — system of record for LAMA; PostgreSQL is the migration target
                  </td>
                </tr>
                <tr>
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">Frontend</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
                    React 19, react-router-dom 7, Tailwind 3.4, Radix UI + shadcn/ui, D3, Mermaid, Monaco Editor
                  </td>
                </tr>
                <tr className="bg-[#FAFAFA]">
                  <td className="px-3 py-2 border border-[#E6E6E6] font-medium">Runtime</td>
                  <td className="px-3 py-2 border border-[#E6E6E6] text-slate-600">
          ...
          <section className="mos-panel p-6" data-testid="about-pilot">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Rocket className="w-5 h-5 mr-2 text-[#FFE600]" />
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 bg-[#F6F6FA] rounded-sm p-4 border border-[#E6E6E6]">
                <div className="text-[10px] uppercase tracking-wider text-slate-500 mb-1">Source Stack</div>
                <div className="font-mono text-sm text-[#2E2E38]">PHP 8 / CodeIgniter 4 / MariaDB</div>
              </div>
              <div className="flex items-center justify-center">
                <ArrowRight className="w-5 h-5 text-[#FFE600]" />
              </div>
              <div className="flex-1 bg-[#FFFCE6] rounded-sm p-4 border border-[#FFE600]">
                <div className="text-[10px] uppercase tracking-wider text-slate-500 mb-1">Target Stack</div>
                <div className="font-mono text-sm text-[#2E2E38]">FastAPI / Python 3.12 / PostgreSQL</div>
              </div>
            </div>
          </section>
          ...
          <section className="mos-panel p-6" data-testid="about-credits">
            <h2 className="font-display text-lg font-bold tracking-tight text-[#2E2E38] mb-4 flex items-center border-b border-[#E6E6E6] pb-2">
              <Users className="w-5 h-5 mr-2 text-[#FFE600]" />
              Credits & Contact
            </h2>
            <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <div className="mt-4 pt-4 border-t border-[#E6E6E6] text-xs text-slate-500">
